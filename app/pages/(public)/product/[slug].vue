  ...
  <div v-if="product" class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      ...
      <div class="space-y-6">
        ...
        <!-- Action Buttons -->
        <div class="space-y-3">
          <UButton color="primary" size="xl" block icon="i-lucide-shopping-cart" label="Agregar al carrito" />
    ...
    <div v-if="product" class="mt-16">
      ...
      <!-- <LazyProductGrid hydrate-on-visible :products="productSuggestions || []" /> -->
